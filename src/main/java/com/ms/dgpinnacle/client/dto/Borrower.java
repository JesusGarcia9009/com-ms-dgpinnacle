...
public class Borrower{
    ...
    public double adjustedAnnualIncome;
    ...
    public String creditReceivedDate;
    ...
    public String hmda2CreditScoreForDecisionMaking;
    ...
    public boolean hmdaGendertypeMaleIndicator;
    ...
    public String jointAssetLiabilityReportingIndicator1;
    ...
    public int numberofTradelines;
    public boolean otherLiabilitiesDoesNotApply;
    public double otherMonthlyIncomeAmount;
    ...
    public boolean realEstateDoesNotApply;
    ...
    public double subtotalLiquidAssetsMinusGiftAmount;
    public String taxIdentificationIdentifier;
    public double totalAssets;
    public double totalLiabilitiesBalanceAmount;
    ...
    public boolean firstTimeHomebuyerIndicator;
}
